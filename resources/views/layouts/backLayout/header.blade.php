                ...
                <ul class="nk-quick-nav">
                    ...
                    @php
                        ...
                        if ($user && isset($user->employee) && $user->employee) {
                            ...
                            // fallback to user fields when admin or non-member user
                            $member = (object) [
                        ...
                        <a href="#" class="dropdown-toggle me-n1" data-bs-toggle="dropdown">
                            <div class="user-toggle">
                                ...
                                <div class="user-info d-none d-xl-block">
                                    ...
                                    <div class="user-name dropdown-indicator">{{ $member->empCode }}</div>
                                </div>
                            </div>
                        </a>
                                ...
                                <ul class="link-list">
                                    <li>
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <button type="submit" class="btn btn-link p-0 text-start text-decoration-none">
